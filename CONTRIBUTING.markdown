Contributing to Attoparser: Terms and Conditions
===============================================

------------------------------------------------------------------------------


Do you want to contribute your work to attoparser? Well, then first and most important: **THANK YOU!** 
...
**Important**: submitting any contributions to the Attoparser project implies your **full acceptance of these terms**,
including the *"Attoparser Individual Contributor License Agreement"* detailed at the end. 
...
First of all, **talk to the [project members](http://www.attoparser.org/team.html)** (an email should do) about 
...
How will your relation with the Attoparser project be?
-----------------------------------------------------
...
[Attoparser Team page](http://www.attoparser.org/team.html). You can opt-out of this if you want. 
...
### Detailed Java code quality standards:
  ...
  - All `.java` files must include the standard Attoparser copyright header.
...
Note the following only applies to documentation/articles meant to be published at the Attoparser website.
  ...
  - Project members may edit and make small changes to your texts --of which you will be informed-- before 
    publishing them.
  - Format and visual styles must adhere to the attoparser website standards, of which you will be informed
...
All Attoparser software is distributed under the **Apache License 2.0** open source license, and your contributions
...
explained in this page, and that it both authorises your contribution to Attoparser and states that will 
never claim any kind of rights over it.



Attoparser Individual Contributor License Agreement
---------------------------------------------------

This contributor agreement ("Agreement") documents the rights granted by contributors to the Attoparser Project. 

This is a legally binding document, so please read it carefully before agreeing to it. The Agreement
may cover more than one software project managed by Attoparser.

###1. Definitions

  * _"Attoparser"_ means the "Attoparser Project organization and members".
  * _"You"_ means the individual who submits a Contribution to Attoparser.
  * _"Contribution"_ means any work of authorship that is submitted by you to Attoparser in which you own
  ...
  * _"Material"_ means the work of authorship which is made available by Attoparser to third parties. When
    ...
    in the Material.
  * _"Submit"_ means any form of electronic, verbal, or written communication sent to Attoparser or its
    representatives, including but not limited to electronic mailing lists, source code control systems,
    and issue tracking systems that are managed by, or on behalf of, Attoparser for the purpose of discussing
  ...
  * _"Submission Date"_ means the date on which you submit a Contribution to Attoparser.
  * _"Effective Date"_ means the date you execute this agreement or the date You first submit a
    Contribution to Attoparser, whichever is earlier.
...
####2.1. Copyright License
  ...
  * (b) To the maximum extent permitted by the relevant law, you grant to Attoparser a perpetual, worldwide,
...
own, control or have the right to grant, now or in the future, you grant to Attoparser a perpetual, worldwide,
...
As a condition on the grant of rights in Sections 2.1 and 2.2, Attoparser agrees to license the Contribution only
...
to assert such moral rights against Attoparser or its successors in interest, or any of our licensees, either 
direct or indirect.


####2.5 Attoparser Rights 

You acknowledge that Attoparser is not obligated to use your Contribution as part of the
Material and may decide to include any Contributions Attoparser considers appropriate.
...
FITNESS FOR A PARTICULAR PURPOSE AND NON-INFRINGEMENT ARE EXPRESSLY DISCLAIMED BY YOU TO ATTOPARSER AND BY
ATTOPARSER TO YOU. TO THE EXTENT THAT ANY SUCH WARRANTIES CANNOT BE DISCLAIMED, SUCH WARRANTY IS LIMITED IN 
...
TO THE MAXIMUM EXTENT PERMITTED BY APPLICABLE LAW, IN NO EVENT WILL YOU OR ATTOPARSER BE LIABLE FOR ANY LOSS OF 
...
###6. Miscellaneous
  ...
  * 6.2 This Agreement sets out the entire agreement between you and Attoparser for your Contributions to Attoparser
        and overrides all other agreements or understandings.
  * 6.3 If You or Attoparser assign the rights or obligations received through this Agreement to a third party, as a
