...
public final class TextUtil {
    ...
    /**
     * <p>
     *   Check equality of two <kbd>CharSequence</kbd> objects. This is equivalent to {@link java.lang.String#equals(Object)}
    ...
    /**
     * <p>
     *   Check equality between a <kbd>CharSequence</kbd> and a <kbd>char[]</kbd> object.
     * </p>
     *
     * @param caseSensitive whether the comparison must be done in a case-sensitive or case-insensitive way.
     * @param text1 the first text to be compared.
    ...
    /**
     * <p>
     *   Check equality between two <kbd>char[]</kbd> objects.
     * </p>
     *
     * @param caseSensitive whether the comparison must be done in a case-sensitive or case-insensitive way.
     * @param text1 the first text to be compared.
    ...
    /**
     * <p>
     *   Check equality between two <kbd>char[]</kbd> objects, specifying (offset,len) pairs for limiting
    ...
    /**
     * <p>
     *   Check equality between a <kbd>CharSequence</kbd> and a <kbd>char[]</kbd> object, specifying (offset,len) pairs
    ...
    /**
     * <p>
     *   Check equality between two <kbd>CharSequence</kbd> objects, specifying (offset,len) pairs
     *   for limiting the fragments to be checked.
     * </p>
     *
     * @param caseSensitive whether the comparison must be done in a case-sensitive or case-insensitive way.
     ...
     * @param text1 the first text to be compared.
     * @param text2 the second text to be compared.
     * @return the value <kbd>0</kbd> if both texts are equal; a value less than <kbd>0</kbd> if the first text
     *         is lexicographically less than the second text; and a value greater than <kbd>0</kbd> if the
    ...
    /**
     * <p>
     *   Searches the specified array of texts (<kbd>values</kbd>) for the specified text &mdash;or a fragment, using an
     *   (offset,len) specification&mdash; using the binary search algorithm.
     * </p>
     * <p>
     *   Note the specified <kbd>values</kbd> parameter <strong>must be lexicographically ordered</strong>.
     * </p>
     *
     * @param caseSensitive whether the comparison must be done in a case-sensitive or case-insensitive way.
     ...
     *         <kbd>(-(<i>insertion point</i>) - 1)</kbd>. The <i>insertion point</i> is defined as the point at
