 ...
 * =============================================================================
 */
package org.attoparser.markup.html.handlers.trace;
...
final class TraceEvent {
    ...
    TraceEvent(final int line, final int col, final String type, final String... content) {
    ...
    boolean matchesTypeAndContent(final TraceEvent event) {
        if (this == event) {
            return true;
        }
        if (event == null) {
