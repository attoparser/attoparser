 ...
 *
 */
public class AutoCloserHtmlElement extends BasicHtmlElement {


    private final ElementPreparationResult preparationResult;


    public AutoCloserHtmlElement(final String name, final String[] autoCloseElements, final String[] autoCloseLimits) {
        ...
        this.preparationResult = new ElementPreparationResult(autoCloseElementsCharArray, autoCloseLimitsCharArray, null);
