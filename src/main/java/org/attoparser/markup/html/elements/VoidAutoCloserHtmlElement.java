 ...
 *
 */
public class VoidAutoCloserHtmlElement extends VoidHtmlElement {


    private final ElementPreparationResult preparationResult;


    public VoidAutoCloserHtmlElement(final String name, final String[] autoCloseElements, final String[] autoCloseLimits) {
