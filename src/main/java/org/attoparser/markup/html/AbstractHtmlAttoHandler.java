 ...
 *
 */
public abstract class AbstractHtmlAttoHandler
        extends AbstractMarkupAttoHandler
        implements IDetailedHtmlElementHandling, IDetailedHtmlAttributeSequenceHandling {
    ...
    protected AbstractHtmlAttoHandler() {
        super();
    }
     ...
     * **************************************************************
     * *                                                            *
     * * IMPLEMENTATION OF IHtmlAttributeSequenceHandling INTERFACE *
     * *                                                            *
     * **************************************************************
     */
