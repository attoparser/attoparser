 ...
 *
 */
public final class TextTracingDetailedMarkupAttoHandler extends AbstractDetailedMarkupAttoHandler {

    
    private final Writer writer;
    
    
    public TextTracingDetailedMarkupAttoHandler(final Writer writer) {
        super();
        this.writer = writer;
    }
    
    public TextTracingDetailedMarkupAttoHandler(final Writer writer, final MarkupParsingConfiguration markupParsingConfiguration) {
