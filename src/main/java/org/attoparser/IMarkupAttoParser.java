 ...
 *   Default implementation is {@link MarkupAttoParser}.
 * </p>
 * <p>
 ...
 * </p>
 * <ul>
 *   <li>{@link AbstractMarkupAttoHandler}: basic implementation only differentiating
 ...
 *   <li>{@link org.attoparser.simple.SimplifierMarkupAttoHandler}: higher-level
 ...
 *   <li>{@link org.attoparser.dom.DOMBuilderMarkupAttoHandler}: handler implementation
 ...
 *
 */
public interface IMarkupAttoParser {
    

    /**
     * <p>
     *   Parse a document using the specified {@link IMarkupAttoHandler}.
     * </p>
     * 
     * @param document the document to be parsed, as a String.
     * @param handler the handler to be used, an {@link IMarkupAttoHandler} implementation.
     ...
     * @throws AttoParseException if the document cannot be parsed.
     */
    public void parse(final char[] document, final int offset, final int len, final IMarkupAttoHandler handler) 
            throws AttoParseException;
     ...
     * @throws AttoParseException if the document cannot be parsed.
     */
    public void parse(final Reader reader, final IMarkupAttoHandler handler) 
            throws AttoParseException;
