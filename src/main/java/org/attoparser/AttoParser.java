 ...
 * =============================================================================
 * 
 *   Copyright (c) 2014-2017, The ATTOPARSER team (https://www.attoparser.org)
 * 
        ...
        if (VERSION == null || VERSION.trim().length() == 0) {
            ...
            try {
                ...
                throw new ExceptionInInitializerError(
                        "Exception during initialization of AttoParser versioning utilities. Identified AttoParser " +
