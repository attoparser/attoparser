 ...
 * @since 2.0.0
 */
public class HtmlNodeSelectorWithAttributeMarkupHandlerTest extends TestCase {

    private static final String RESOURCES_FOLDER = "htmlnodeselectorwithattribute/";

    public HtmlNodeSelectorWithAttributeMarkupHandlerTest() {
        super();
    }
