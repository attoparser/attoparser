 ...
 * @since 2.0.0
 */
public class XmlBlockSelectorMarkupHandlerTest {
    ...
    public void test() throws Exception {
        ...
        final ParseConfiguration config = ParseConfiguration.xmlConfiguration();
        config.getPrologParseConfiguration().setValidateProlog(false);
